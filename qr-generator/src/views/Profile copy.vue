<template>
  ...
  <v-form
    ><v-card class="d-flex align-start mb-4" color="background" :elevation="0">
      <v-sheet color="background" :elevation="0" class="w-100">
        <v-card-title class="mt-2 mb-2 pa-0"> Основные настройки </v-card-title>
        <v-sheet color="background" :elevation="0" class="d-flex mr-5">
          ...
          <div class="mr-6 w-100">
            <v-card-subtitle class="mb-2 mt-2">Отступ</v-card-subtitle>
            <v-slider
              class="ml-5"
              @update:modelValue="changeMainSettings"
              :min="0"
        ...
        <v-card-title class="mt-2 mb-2 pa-0">
        ...
        >
          <div class="mr-6 w-100">
            <v-card-subtitle class="mb-2 mt-2">Изображение</v-card-subtitle>
            <v-file-input
          ...
          <div class="mr-6 w-100">
            <v-card-subtitle class="mb-2 mt-2">Отступы</v-card-subtitle>
            <v-slider
              class="ml-5"
              @update:modelValue="changeStyleImage"
              :min="0"
        ...
        <v-sheet color="background" :elevation="0" class="d-flex mb-5">
          <div class="mr-6">
            <v-card-title class="mt-2 mb-2 pa-0">
              Настройки точек
            </v-card-title>
            ...
            >
              ...
              <div class="">
                ...
                <div v-if="refDotsIsGradient">
                  ...
                  <v-card-subtitle class="mb-2 mt-2">Положение</v-card-subtitle>
                  <v-slider
                    class="ml-5"
              ...
              <div class="w-100">
                ...
                <div v-else-if="refCornersSquareIsGradient" class="d-flex">
                  <v-color-picker
                    ...
                    @update:model-value="changeStyleCornersSquare"
                    v-model="
                      refSettingsQR.cornersSquareOptions.gradient.colorStops[0]
                        .color
                    "
                  ></v-color-picker>
                  <v-color-picker
                    ...
                    @update:model-value="changeStyleCornersSquare"
                    v-model="
                      refSettingsQR.cornersSquareOptions.gradient.colorStops[1]
                        .color
                    "
                  ></v-color-picker>
                </div>
        ...
        >
              ...
              <div class="w-100">
                ...
                <div v-if="refСornersDotIsGradient">
                  ...
                  <v-slider
                    ...
                    :max="180"
                    :step="1"
                    v-model="refSettingsQR.cornersDotOptions.gradient.rotation"
                    thumb-label="always"
                  ></v-slider>
                </div>
                <v-color-picker
          ...
          <v-divider vertical></v-divider>
          <div class="ml-6">
            <v-card-title class="mt-2 mb-2 pa-0"> Настройки фона </v-card-title>
            <v-sheet
              color="background"
              :elevation="0"
              class="d-flex flex-column"
              ...
              <div class="mr-3 w-100">
                ...
                <div v-if="refBackgroundIsGradient">
                  ...
                  <v-slider
                    ...
                    :max="180"
                    :step="1"
                    v-model="refSettingsQR.backgroundOptions.gradient.rotation"
                    thumb-label="always"
                  ></v-slider>
                </div>
                <v-color-picker
    ...
    <div class="">
      <v-btn
        color="primary"
        class="text-none text-uppercase mr-5"
        :loading="isLoading"
